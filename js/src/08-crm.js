...
function renderLeads(stats) {
  ...
  <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;flex-wrap:wrap;gap:8px">
    ...
    <button onclick="exportLeadsExcel()" style="background:#15803d;color:#fff;border:none;border-radius:8px;padding:7px 16px;font-size:13px;font-weight:700;cursor:pointer;font-family:inherit;margin-left:6px">⬇ تصدير Excel</button>
